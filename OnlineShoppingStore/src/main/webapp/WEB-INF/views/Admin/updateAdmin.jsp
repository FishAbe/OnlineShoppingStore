...
<div class="well" style="width: 60%; margin: auto">
		<h2>Admin Modification</h2>
		<form:form modelAttribute="admin"
				action="/OnlineShoppingStore/spring/admin/update/${admin.id}"
				method="post">
			<br />
			<h3>Personal Info</h3>
	       ...
	       <h3>Address Information</h3>
			<div class="row">
				...
				<div class="col-md-2">
					<form:errors path="address.street" class="alert alert-danger"
							role="alert" />
				</div>
				...
				<div class="col-md-4">
					<div class="input-group">
						...
						<form:input type="address.city" path="password"
								class="form-control" />
					</div>
				</div>
				<div class="col-md-2">
					<form:errors path="address.city" class="alert alert-danger"
							role="alert" />
				</div>
			</div>
			<br />
			...
			<div class="row">
				...
				<div class="col-md-2">
					<form:errors path="address.zip" class="alert alert-danger"
							role="alert" />
				</div>
				...
				<div class="col-md-4">
					<div class="input-group">
						...
						<form:input type="address.state" path="password"
								class="form-control" />
					</div>
				</div>
				<div class="col-md-2">
					<form:errors path="address.state" class="alert alert-danger"
							role="alert" />
				</div>
			</div>
			<br />
